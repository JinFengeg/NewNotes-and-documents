#include "stdio.h"
 ...
 void ad7606_trigger_set(void)
 {
    ...
    system("echo 16 > /sys/bus/iio/devices/iio:device2/buffer/length");
...
fd = open("/dev/iio:device2", O_RDONLY);
 ...
 printf("in_voltage1_raw = %d",ad7606.in_voltage1_raw);
 printf("in_voltage2_raw = %d",ad7606.in_voltage2_raw);
 printf("in_voltage3_raw = %d",ad7606.in_voltage3_raw);
 printf("in_voltage4_raw = %d",ad7606.in_voltage4_raw);
 printf("in_voltage5_raw = %d",ad7606.in_voltage5_raw);
 printf("in_voltage6_raw = %d",ad7606.in_voltage6_raw);
 printf("in_voltage7_raw = %d",ad7606.in_voltage7_raw);
 printf("\r\n实际值:\r\n");
