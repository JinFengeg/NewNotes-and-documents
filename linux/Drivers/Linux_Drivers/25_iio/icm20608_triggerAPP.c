...
{
	system("echo 1 > /sys/bus/iio/devices/iio:device3/scan_elements/in_accel_x_en");
	system("echo 1 > /sys/bus/iio/devices/iio:device3/scan_elements/in_accel_y_en");	
	system("echo 1 > /sys/bus/iio/devices/iio:device3/scan_elements/in_accel_z_en");
	system("echo 1 > /sys/bus/iio/devices/iio:device3/scan_elements/in_anglvel_x_en");
	system("echo 1 > /sys/bus/iio/devices/iio:device3/scan_elements/in_anglvel_y_en");
	system("echo 1 > /sys/bus/iio/devices/iio:device3/scan_elements/in_anglvel_z_en");
	system("echo 1 > /sys/bus/iio/devices/iio:device3/scan_elements/in_temp_en");

	system("echo icm20608-dev3 > /sys/bus/iio/devices/iio:device3/trigger/current_trigger");
	system("echo 14 > /sys/bus/iio/devices/iio:device3/buffer/length");
	system("echo 1 > /sys/bus/iio/devices/iio:device3/buffer/enable");
}
...
int icm20608_read(int fd, struct icm20608_dev *dev)
{
	...
	file_data_read("/sys/bus/iio/devices/iio:device3/in_accel_scale", str);
	dev->accel_scale = atof(str);

	file_data_read("/sys/bus/iio/devices/iio:device3/in_anglvel_scale", str);
	dev->gyro_scale = atof(str);

	file_data_read("/sys/bus/iio/devices/iio:device3/in_temp_scale", str);
...
int main(int argc, char *argv[])
{
    ...
    if(2 != argc) {
        printf("Usage:\n"
               "\t./icm20608_triggerApp /dev/iio:device3\n"
              );
        return -1;
    }
