 ...
 "/sys/bus/iio/devices/iio:device3/in_accel_scale",
 "/sys/bus/iio/devices/iio:device3/in_accel_x_calibbias",
 "/sys/bus/iio/devices/iio:device3/in_accel_x_raw",
 "/sys/bus/iio/devices/iio:device3/in_accel_y_calibbias",
 "/sys/bus/iio/devices/iio:device3/in_accel_y_raw",
 "/sys/bus/iio/devices/iio:device3/in_accel_z_calibbias",
 "/sys/bus/iio/devices/iio:device3/in_accel_z_raw",
 "/sys/bus/iio/devices/iio:device3/in_anglvel_scale",
 "/sys/bus/iio/devices/iio:device3/in_anglvel_x_calibbias",
 "/sys/bus/iio/devices/iio:device3/in_anglvel_x_raw",
 "/sys/bus/iio/devices/iio:device3/in_anglvel_y_calibbias",
 "/sys/bus/iio/devices/iio:device3/in_anglvel_y_raw",
 "/sys/bus/iio/devices/iio:device3/in_anglvel_z_calibbias",
 "/sys/bus/iio/devices/iio:device3/in_anglvel_z_raw",
 "/sys/bus/iio/devices/iio:device3/in_temp_offset",
 "/sys/bus/iio/devices/iio:device3/in_temp_raw",
 "/sys/bus/iio/devices/iio:device3/in_temp_scale",
 };
